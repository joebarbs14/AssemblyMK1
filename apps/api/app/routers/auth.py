...
def demo_staff_seed() -> dict[str, object]:
    ...
    Both GET and POST are accepted so this works from a browser address
    bar. Not a production endpoint; the credentials it creates are public
    and documented."""
